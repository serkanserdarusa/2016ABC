public class Day_6_InstanceAndStaticVariable2 {
    ...
    public static void main(String[] args) {
        ...
        Day_6_InstanceAndStaticVariable2 abc=new Day_6_InstanceAndStaticVariable2();

        System.out.println(name);//by variable name==>static
        System.out.println(Day_6_InstanceAndStaticVariable2.name);//by class==>static
        System.out.println(abc.name);//by created object==>static

        System.out.println(abc.name1);//by created object==>instance

        test();//static method
        Day_6_InstanceAndStaticVariable2.test();//static method
